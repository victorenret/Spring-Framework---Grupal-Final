...
<body>
	...
	<div align="center">
        ...
        <form:form action="cliente/crearCliente" method="post"  modelAttribute="client">
            <table class="editCapa" border="0" cellpadding="5">
                ...
                <tr>
                 ...
                 <tr>
                    <td>Apellidos: </td>
                    <td><form:input type="text" class="form-control" path="apellidos" /></td>
                </tr>
                <tr>
                    <td>Teléfono: </td>
                    <td><form:input type="text" class="form-control" path="telefono" /></td>
                </tr>
                <tr>
                    <td>AFP: </td>
                    <td><form:input type="text" class="form-control" path="afp" /></td>
                </tr>
                <tr>
                    <td>Sistema de salud: </td>
                    <td><form:input type="text" class="form-control" path="prevSalud" /></td>
                </tr>
                 <tr>
                    <td>Dirección: </td>
                ...
                <tr>
                    <td>Comuna: </td>
                    <td><form:input type="text" class="form-control" path="comuna" /></td>
                </tr>
