    ...
    <div align="center">
        ...
        <form:form action="crearCapacitacion" method="post"  modelAttribute="capacitacion">
            <table class="editCapa" border="0" cellpadding="5">
                <tr>
                    <td>ID: </td>
                    <td>${capacitacion.id}<form:hidden path="id"/></td>
                </tr>        
                <tr>
                    <td>Rut Cliente: </td>
                ...
                <tr>
                    <td>Día: </td>
                    <td><form:input type="date" class="form-control" path="dia" /></td>
                </tr>
                <tr>
                    <td>Hora: </td>
                 ...
                 <tr>
                    <td>Lugar: </td>
                    <td><form:input type="text" class="form-control" path="lugar" /></td>
                </tr>
                <tr>
                    <td>Duracion: </td>
                    <td><form:input type="text" class="form-control" path="duracion" /></td>
                </tr>
                <tr>
                    <td>Cantidad de asistentes: </td>
                    <td><form:input type="number" class="form-control" path="cantAsist" /></td>
                </tr>  
