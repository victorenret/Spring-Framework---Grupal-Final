...
<body>
	...
	<div align="center">
        ...
        <form:form action="administrativo/crearAdministrativo" method="post"  modelAttribute="adm">
            <table class="editCapa" border="0" cellpadding="5">
                <tr>
                    <td>ID: </td>
                    <td>${adm.id}<form:hidden path="id"/></td>
                </tr>        
                <tr>
                    <td>Rut: </td>
                ...
                <tr>
                 ...
                 <tr>
                    <td>Área: </td>
                    <td><form:input type="text" class="form-control" path="area" /></td>
                </tr>
                <tr>
                    <td>Experiencia Previa: </td>
                    <td><form:input type="text" class="form-control" path="expPrevia" /></td>
                </tr>
